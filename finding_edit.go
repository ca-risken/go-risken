...
func (c *Client) ListFindingForOrg(ctx context.Context, req *proto.ListFindingForOrgRequest) (*proto.ListFindingForOrgResponse, error) {
	httpReq, err := c.NewRequest(ctx, "GET", "/api/v1/finding/list-finding-for-organization", req)
	if err != nil {
		return nil, err
	}
	...
	var resp proto.ListFindingForOrgResponse
	if err := decodeBodyWithDataKey(httpResp, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
